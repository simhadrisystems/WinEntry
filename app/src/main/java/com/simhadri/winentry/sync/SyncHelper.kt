...
object SyncHelper {
    ...
    private fun showProductSyncModeDialog(
        ...
        val disclaimer = android.widget.TextView(context).apply {
            text = "The downloaded product list is for reference only. " +
                   "Please review and update the codes, names, and prices to " +
                   "match your actual business before use. " +
                   "Your customisations (Active status, Sort Key) are preserved on " +
                   "Update and reset to master values on Full Reset."
            textSize = 11.5f
            setTextColor(android.graphics.Color.parseColor("#757575"))
