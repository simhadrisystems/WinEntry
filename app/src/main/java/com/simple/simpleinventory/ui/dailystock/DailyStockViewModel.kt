...
import com.simple.simpleinventory.data.entity.ProductSizeQty
import com.simple.simpleinventory.data.entity.stockCode
import com.simple.simpleinventory.data.repository.CascadePreview
import com.simple.simpleinventory.data.repository.CascadeResult
...
class DailyStockViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val purchaseChangeObserver =
        Observer<List<com.simple.simpleinventory.data.entity.Purchase>> {
    ...
    private suspend fun buildEntry(
        ...
        purchaseDao: com.simple.simpleinventory.data.dao.PurchaseDao
    ): DailyEntry {
