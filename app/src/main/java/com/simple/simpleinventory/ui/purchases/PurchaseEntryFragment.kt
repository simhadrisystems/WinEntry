...
import com.simple.simpleinventory.databinding.FragmentPurchaseEntryBinding
...
class PurchaseEntryFragment : Fragment() {
    ...
    private fun populateUIForEdit(purchase: Purchase, @Suppress("UNUSED_PARAMETER") product: com.simple.simpleinventory.data.entity.Product) {
    ...
    private fun updateProductInfo(product: com.simple.simpleinventory.data.entity.Product) {
                    ...
                    MaterialAlertDialogBuilder(requireContext())
                        ...
                        .setPositiveButton("Edit Existing") { _, _ ->
                            ...
                            navController.navigate(
                                com.simple.simpleinventory.R.id.action_purchasesList_to_purchaseEntry,
                                bundle
                            )
                        }
