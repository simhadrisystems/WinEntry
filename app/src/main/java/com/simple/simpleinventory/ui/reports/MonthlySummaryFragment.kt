package com.simple.simpleinventory.ui.reports
...
import com.simple.simpleinventory.ui.purchases.DeleteDateRangeDialog
...
class MonthlySummaryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = LinearLayout(ctx).apply {
            ...
            setBackgroundColor(androidx.core.content.ContextCompat.getColor(ctx, com.simple.simpleinventory.R.color.app_surface))
        }
        ...
        toolbar = androidx.appcompat.widget.Toolbar(ctx).apply {
            ...
            setBackgroundColor(androidx.core.content.ContextCompat.getColor(ctx, com.simple.simpleinventory.R.color.app_toolbar))
            setTitleTextColor(Color.WHITE)
            title = "Monthly Summary"
            setNavigationIcon(com.simple.simpleinventory.R.drawable.ic_chevron_left)
            setNavigationOnClickListener { findNavController().navigateUp() }
            inflateMenu(com.simple.simpleinventory.R.menu.menu_monthly_summary)
            overflowIcon = androidx.core.content.ContextCompat.getDrawable(ctx, com.simple.simpleinventory.R.drawable.ic_more_vert)
    ...
    private fun onMenuItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            com.simple.simpleinventory.R.id.action_share -> { shareAsText(); true }
            com.simple.simpleinventory.R.id.action_print -> { printOrPdf();  true }
            com.simple.simpleinventory.R.id.action_import_reconciliation -> {
                importReconciliationFromCloud(); true
            }
            com.simple.simpleinventory.R.id.action_delete_reconciliation_range -> {
